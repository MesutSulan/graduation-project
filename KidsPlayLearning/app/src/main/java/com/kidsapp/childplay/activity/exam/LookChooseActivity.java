package com.kidsapp.childplay.activity.exam;
...
import com.kidsapp.childplay.adapter.ExamQuestionAdapter;
import com.kidsapp.childplay.model.LearningDataModel;
...
//    ArrayList<Integer> arrOfPreviousPosition = new ArrayList<>();
    ...
    //İngilizce Olarak yayınlayacağım Sadece Bitirme Projesi Olarak Sunacağım
    public void prepareDataForLearning(int i2) {
        if (i2 == 0) {
            learningDataModelArrayList = new ArrayList();
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.a, "A harfi için Anne", "A"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.b, "B harfi için Baba", "B"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.c, "C harfi için Cennet", "C"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.c_harfi, "Ç harfi için Çilek", "Ç")); //resim ekle
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.d, "D harfi için Defter", "D"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.e, "E harfi için Eldiven", "E"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.f, "F harfi için Fatma", "F"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.g, "G harfi için Güven", "G"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.h, "H harfi için Hasta", "H"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.i, "I harfi için Irmak", "I"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.i_harfi, "İ harfi için İstanbul", "İ")); // resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.j, "J harfi için Jale", "J"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.k, "K harfi için Kader", "K"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.l, "L harfi için Liman", "L"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.m, "M harfi için Mandalina", "M"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.n, "N harfi için Nutella", "N"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.o, "O harfi için Orman", "O"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.o_harfi, "Ö harfi için Öküz", "Ö")); //resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.p, "P harfi için Portakal", "P"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.r, "R harfi için Rabia", "R"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.s, "S harfi için Sinan", "S"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.s_harfi, "Ş harfi için Şeyma", "Ş")); // resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.t, "T harfi için Toplama", "T"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.u, "U harfi için UĞur Böceği", "U"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.u_harfi, "Ü harfi için Ünsal", "Ü")); // resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.v, "V harfi için Volkan", "V"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.y, "Y harfi için Yunus", "Y"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.z, "Z harfi için Zebra", "Z"));
        } else if (i2 == 1) {
            learningDataModelArrayList = new ArrayList();
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.zero_0, "Sıfır", "0"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.one_1, "Bir", "1"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.two_2, "İki", "2"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.three_3, "Üç", "3"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.four_4, "Dört", "4"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.five_5, "Beş", "5"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.six_6, "Altı", "6"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.seven_7, "Yedi", "7"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.eight_8, "Sekiz", "8"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.nine_9, "Dokuz", "9"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.ten_10, "On", "10"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.eleven_11, "On Bir", "11"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.twelve_12, "On İki", "12"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.thirteen_13, "On Üç", "13"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.fourteen_14, "On Dört", "14"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.fifteen_15, "On Beş", "15"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.sixteen_16, "On Altı", "16"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.seventeen_17, "On Yedi", "17"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.eighteen_18, "On Sekiz", "18"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.nineteen_19, "On Dokuz", "19"));
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.twenty_20, "Yirmi", "20"));
//        } else if (i2 == 2) {
//            learningDataModelArrayList = new ArrayList();
...
//            learningDataModelArrayList.add(new LearningDataModel(R.drawable.truck, "Truck", "Truck"));
            ...
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.b, "B harfi için Baba", "B"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.c, "C harfi için Cennet", "C"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.c, "Ç harfi için Çilek", "Ç")); //resim ekle
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.d, "D harfi için Defter", "D"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.e, "E harfi için Eldiven", "E"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.f, "F harfi için Fatma", "F"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.g, "G harfi için Güven", "G"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.h, "H harfi için Hasta", "H"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.i, "I harfi için Irmak", "I")); // resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.i, "İ harfi için İstanbul", "İ"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.j, "J harfi için Jale", "J"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.k, "K harfi için Kader", "K"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.l, "L harfi için Liman", "L"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.m, "M harfi için Mandalina", "M"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.n, "N harfi için Nutella", "N"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.o, "O harfi için Orman", "O"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.o, "Ö harfi için Öküz", "Ö")); //resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.p, "P harfi için Portakal", "P"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.r, "R harfi için Rabia", "R"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.s, "S harfi için Sinan", "S"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.s, "Ş harfi için Şeyma", "Ş")); // resim ata
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.t, "T harfi için Toplama", "T"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.u, "U harfi için UĞur Böceği", "U"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.u, "Ü harfi için Ünsal", "Ü"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.v, "V harfi için Volkan", "V"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.y, "Y harfi için Yunus", "Y"));
            learningDataModelArrayList.add(new LearningDataModel(R.drawable.z, "Z harfi için Zebra", "Z"));
        }
