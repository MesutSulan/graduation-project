...
import static com.kidsapp.childplay.customclasses.Constant.switchState;
...
public class SettingActivity extends AppCompatActivity {
    ...
    public void ContactUs(View view) {
        try {
            ...
            sendIntentGmail.putExtra(Intent.EXTRA_EMAIL, new String[]{"mesut0sulan@gmail.com"});
            ...
            sendIntentIfGmailFail.putExtra(Intent.EXTRA_EMAIL, new String[]{"mesut0sulan@gmail.com"});
            if (getResources().getString(R.string.app_name) != null)
    ...
    public void MoreApp(View view) {
        Uri uri = Uri.parse("https://play.google.com/store/apps/developer?id=MMBGMM+World+Musics");
