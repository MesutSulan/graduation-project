package com.kidsapp.childplay.utils;
...
import com.kidsapp.childplay.interfaces.CallbackListener;
...
public class Utils {
    ...
    public static void openInternetDialog(final CallbackListener callbackListener, final Boolean isSplash, final Context context) {
        if (!Utils.isNetworkConnected(context)) {
            ...
            builder.setMessage("Lütfen! İnternete Bağlı Olduğunuzu Kontrol Edin");
            builder.setNegativeButton("Tekrar Deneyin", new DialogInterface.OnClickListener() {
                @Override
