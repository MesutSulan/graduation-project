...
import com.kidsapp.childplay.model.ModelVideo;
...
public class VideoPlayActivity extends YouTubeBaseActivity implements YouTubePlayer.OnFullscreenListener {
    ...
    private void initVideoPlayer() {
        videoTitleOfVideo.setText(arrOfVideoList.get(POSITION).getVideoTitle()); // AIzaSyDWYXoqet-qsx7obD5Aijj8-QmAA8Q2ZV0
        youTubePlayerView.initialize("AIzaSyCHubEGneY-U-2mxpoDZswAmfHcSQ5r6t8", new YouTubePlayer.OnInitializedListener() {
            @Override
            ...
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Toast.makeText(context, "Video Yüklenemedi", Toast.LENGTH_SHORT).show();
            }
        });
    }
