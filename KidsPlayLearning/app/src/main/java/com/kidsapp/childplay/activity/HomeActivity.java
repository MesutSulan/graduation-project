...
import com.kidsapp.childplay.adapter.HomeCategoriesAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void initDefine() {
        ...
        if(type==1){
            txtExamTitle.setText("Okul Öncesi Öğrenim");
        }else if(type==2){
            txtExamTitle.setText("Bak ve Çöz");
        }else if(type==3){
            txtExamTitle.setText("Dinle Ve Tahmin Et");
        }  //İngilizce Olarak yayınlayacağım Sadece Bitirme Projesi Olarak Sunacağım
        homeCategoryTitles = new String[]{"Alfabe", "Rakamlar"/*, "Colors", "Shapes", "Animals", "Birds", "Flowers", "Fruits", "Month", "Vegetable", "Body Parts", "Clothes", "Country", "Food", "Geometry", "House", "Jobs", "School", "Sports", "Vehicle"*/};
