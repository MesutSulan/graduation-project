package com.kidsapp.childplay.adapter;
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (learningDataModel.showTitle.equals(examQuestionAnswerList.get(i).showTitle)) {
                    Toast.makeText(context, "Aferin", Toast.LENGTH_SHORT).show();
                    ...
                    if (Utils.getPref(Constant.SOUND,true)) {
                        AppControl.textToSpeech.speak("Aferin", TextToSpeech.QUEUE_FLUSH, null);
                    }
                } else {
                    Toast.makeText(context, "Yapabilirsin", Toast.LENGTH_SHORT).show();
                    viewHolder.lloutExamAnswer.setBackgroundColor(context.getResources().getColor(R.color.colorWrong));
                    if (Utils.getPref(Constant.SOUND,true)) {
                        AppControl.textToSpeech.speak("Yapabilirsin", TextToSpeech.QUEUE_FLUSH, null);
                    }
                }
            }
        });
