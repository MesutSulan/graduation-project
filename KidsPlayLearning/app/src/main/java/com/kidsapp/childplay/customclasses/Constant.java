...
public class Constant {
    public static String DB_PATH = "data/data/com.kidsapp.childplay/databases/";
    ...
    public static final String GOOGLE_BANNER_ID = "";
    public static final String GOOGLE_INTERSTITIAL_ID = "";


    public static final String FB_BANNER_ID = "";
    public static final String FB_INTERSTITIAL_ID = "";
